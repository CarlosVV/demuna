var winExpediente;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////// 
		...
		//'agrafdemuna.php?cargar=true&demuna='+txtKyDemunaIni.getValue(),		
		...
		var grid1Demunas = new Ext.grid.GridPanel({			
			...
			columns:[								 					 
				...
				{header: 'Materia', 	width:150, sortable: true, dataIndex: 'Nombres', hidden:false},	
		...
		function AbrirExpedientes(){		
				if (!winExpediente) {
					winExpediente = new Ext.Panel({
						...
						width: 1000,
						height: 509,		
						title: 'Reporte por Materias en esta Demuna',			
						resizable: false,
						closeAction: 'hide',
						closable: false,						
						draggable: true,
