var winExpediente, clavederegistro, clavederegistroCompromiso;
...
var storeEliminarCompromiso = new Ext.data.JsonStore({
	url : 'formcompromiso/eliminarcompromiso.htm'// url:'formcompromiso.php?eliminarcompromiso=true'
});

var btnEliminarCompromiso = new Ext.Button({
	id : 'btnEliminarCompromiso',
	width : 100,
	iconAlign : 'top',
	text : 'Eliminar',
	...
	disabled : true,
	handler : function() {
		storeEliminarCompromiso.load({
			params : {
				KyCompromiso : clavederegistroCompromiso
			},
			callback : function() {
				estoreActas.load({
					params : {
...
var btnEditarCompromiso = new Ext.Button({
	id : 'btnEditarCompromiso',
	x : 240,
	y : 470,
	width : 100,
	iconAlign : 'top',
...
clickgrid.gridclik = {
	...
	editMovie : function(grid1, index, event) {
		...
		btnEditarCompromiso.setDisabled(true);
		btnEliminarCompromiso.setDisabled(true);
	},
...
// /////////////////////////////////////////////////////////////////////////////////////////////////////
// ///////////////////////// ///////////////////////////
// //////////////////////// CONFIGURACION DEL GRID Compromiso
// ///////////////////////////
// //////////////////////// ///////////////////////////
// /////////////////////////////////////////////////////////////////////////////////////////////////////

var estoreActas = new Ext.data.JsonStore({
	url : 'formcompromiso/cargardatoscompromiso.htm',// 'formcompromiso.php?cargardatoscompromiso=true&idempresa=1',
	// //+sessvars.idempresa
	root : 'data',
	totalProperty : 'total',
	paramNames : {
	...
	fields : [ 'KyCompromiso', 'DescripcionCaso', 'Compromiso', 'Seguimiento',
			'Fecha' ]
});

var pagerCompromiso = new Ext.PagingToolbar({
	store : estoreActas,
	displayInfo : true,
	displayMsg : 'Registro {0} al {1} de un total de {2}',
	emptyMsg : 'No hay registros que mostrar.',
...
var myReaderCompromiso = new Ext.data.ArrayReader({}, [ {
	name : 'KyCompromiso'
}, {
...
var grid1Compromiso = new Ext.grid.GridPanel(
		{
			title : 'Acta de Compromiso',
			frame : false,
			store : estoreActas,
			reader : myReaderCompromiso,
			columns : [ new Ext.grid.RowNumberer(), {
				header : 'KyCompromiso',
				width : 50,
				sortable : true,
				dataIndex : 'KyCompromiso',
				hidden : true
			}, {
				header : 'Descripcion Caso',
				width : 200,
				sortable : true,
				dataIndex : 'DescripcionCaso'
			}, {
				header : 'Compromisos',
				width : 200,
				sortable : true,
			...
			height : 180,
			frame : false,
			bbar : [ pagerCompromiso, '->', btnEditarCompromiso,
...
clickgrid.gridclik = {
	init : function() {
		grid1Compromiso.on('rowdblclick', this.editRegistro);
		grid1Compromiso.on('rowclick', this.editMovie);
	},
	editMovie : function(grid1Compromiso, index, event) {
		var record = grid1Compromiso.getStore().getAt(index);
		clavederegistroCompromiso = record.get('KyCompromiso');

		// ////////////////////// Datos de Solicitud ////////////////////
		txtKy.setValue(record.get('KyCompromiso'));
		TxtDescripcionCaso.setValue(record.get('DescripcionCaso'));
		TxtCompromiso.setValue(record.get('Compromiso'));
		TxtSeguimiento.setValue(record.get('Seguimiento'));
		txtFechaCompromiso.setValue(record.get('Fecha'));

		// ////////////////////// Datos de Solicitud ////////////////////
		btnEditarCompromiso.setDisabled(false);
		btnEliminarCompromiso.setDisabled(false);
...
var FrmExpediente = new Ext.FormPanel(
		{
			...
			buttonAlign : 'right',
			tbar : [ '->', btnCompromiso ],
			items : [ grid1, grid1Compromiso ], // btnImagen
			tbar : [ lblFiltrar, comboFiltroEspec, lblFiltrara,
					txtFiltrarEspec, btnBuscarYaEspec, '->', btnCompromiso ],
